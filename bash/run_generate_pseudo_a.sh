...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      echo "Usage: bash run_generate_pseudo_a.sh [--input PATH] [--output PATH] [--max-new-tokens N] [--temperature T] [--top-p P] [--save-every N] [--quantization none|8bit|4bit] [--double-quant] [--quant-type nf4|fp4]"
      exit 0 ;;
    *)
